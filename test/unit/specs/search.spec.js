...
describe('Search', () => {
  ...
  it('create a search', () => {
    ...
    expect(wrapper.hasClass('vu-search')).to.be.true;
  ...
  it('focus on input', () => {
    ...
    const input = wrapper.find('.vu-search__input')[0];
    input.trigger('focus');
  ...
  it('handle clean click and refocus', (done) => {
    ...
    const cleanBtn = wrapper.find('.vu-icon-clear')[0];
  ...
  it('handle cancel click', (done) => {
    ...
    const cancelBtn = wrapper.find('.vu-search__action-text')[0];
