    ...
    <div class="page-content">
      ...
      <ul class="list-ios hl-list-borderless">
        <router-link tag="li" class="item-icon-right" :to="{ name: 'checkbox'}">
           <span class="item-note">Checkbox复选框</span>
        ...
        <router-link tag="li" class="item-icon-right" :to="{ name: 'badge'}">
          <span class="item-note">badge徽章</span>
          <i class="icon ion-ios-arrow-right"></i>
        </router-link>

        <router-link tag="li" class="item-icon-right" :to="{ name: 'layout'}">
          <span class="item-note">layout布局</span>
          <i class="icon ion-ios-arrow-right"></i>
        </router-link>

        <router-link tag="li" class="item-icon-right" :to="{ name: 'loading'}">
           <span class="item-note">loading加载</span>
          <i class="icon ion-ios-arrow-right"></i>
        </router-link>

        <router-link tag="li" class="item-icon-right" :to="{ name: 'button'}">
           <span class="item-note">button按钮</span>
          <i class="icon ion-ios-arrow-right"></i>
        </router-link>
        ...
        <router-link tag="li" class="item-icon-right" :to="{ name: 'noticeBar'}">
          <span class="item-note">noticeBar通告栏</span>
          <i class="icon ion-ios-arrow-right"></i>
        </router-link>

        <router-link tag="li" class="item-icon-right" :to="{ name: 'pagination'}">
          <span class="item-note">Pagination 分页</span>
          <i class="icon ion-ios-arrow-right"></i>
        </router-link>
    
        <router-link tag="li" class="item-icon-right" :to="{ name: 'stepper'}">
          <span class="item-note">Stepper步进器</span>
          <i class="icon ion-ios-arrow-right"></i>
        </router-link>

        <router-link tag="li" class="item-icon-right" :to="{ name: 'search'}">
          <span class="item-note">search搜索</span>
          <i class="icon ion-ios-arrow-right"></i>
        </router-link>
        ...
        <router-link tag="li" class="item-icon-right" :to="{ name: 'field'}">
          <span class="item-note">输入框</span>
          <i class="icon ion-ios-arrow-right"></i>
        </router-link>

        <router-link tag="li" class="item-icon-right" :to="{ name: 'imagePreview'}">
          <span class="item-note">imagePreview图片预览</span>
          <i class="icon ion-ios-arrow-right"></i>
        </router-link>

        <router-link tag="li" class="item-icon-right" :to="{ name: 'lazyload'}">
          <span class="item-note">lazyload图片懒加载</span>
          <i class="icon ion-ios-arrow-right"></i>
        </router-link>
        
        <router-link tag="li" class="item-icon-right" :to="{ name: 'range'}">
          <span class="item-note">Range</span>
        </router-link>
        <router-link tag="li" class="item-icon-right" :to="{ name: 'infiniteScroll'}">
          <span class="item-note">infiniteScroll</span>
          <i class="icon ion-ios-arrow-right"></i>
        </router-link>
      ...
      <ul class="list-ios hl-list-borderless">
        ...
        <router-link tag="li" class="item-icon-right" :to="{ name: 'popup'}">
          <span class="item-note">popup</span>
          <i class="icon ion-ios-arrow-right"></i>
        </router-link>

        <router-link tag="li" class="item-icon-right" :to="{ name: 'picker'}">
          <span class="item-note">picker选择器</span>
          <i class="icon ion-ios-arrow-right"></i>
        </router-link>
      </ul>
      ...
      <h3>高级</h3>
      <ul class="list-ios hl-list-borderless">
        <router-link tag="li" class="item-icon-right" :to="{ name: 'area'}">
          <span class="item-note">area省市区选择器</span>
          <i class="icon ion-ios-arrow-right"></i>
        </router-link>
